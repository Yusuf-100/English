...
* `So + Adj` 位於句首的倒裝
  ...
  * 詳見[此處](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-4-wen-fa-zheng-li)。
* 地方副詞 / 片語位於句首的倒裝
...
這與之前學過的[假設語氣](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-7-wen-fa-zheng-li)不同，請小心。
...
* Demand
  ...
  * (v.) 需求、要求
    * 常見用法為 `demand + N / to VR`, `demand + that + S + (should) + VR` (虛擬語氣)。虛擬語氣的介紹詳見[此處](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-16-wen-fa-zheng-li)。
...
* With ... interwoven 隨著...交織在一起
  * 這是一個 [`with + O + OC`](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-22-wen-fa-zheng-li) 的結構。
...
* 分詞構句
  ...
  * 其他有關分詞構句的介紹詳見[此處](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-6-wen-fa-zheng-li)。
...
* `Have + O + p.p.` (被動受詞補語)
  * 當某物與動作之間是<mark style="color:blue;">**被動關係**</mark>時，受詞補語須使用 `p.p.`。`make` 也有類似用法，詳見[此處](zuo-wen-bai-ju-150.md#zuo-wen-bai-ju-8-wen-fa-zheng-li)。
